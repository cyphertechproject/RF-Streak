  ...
  return (
    <section id="community" className="py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
         <img 
            src="https://wallpaperaccess.com/full/3308134.jpg"
      ...
      <Container className="relative z-10">
        <div className="bg-gradient-to-r from-streak-900/40 to-black/60 border border-streak-500/30 rounded-2xl p-8 md:p-16 backdrop-blur-sm text-center">
          ...
          <p className="font-rajdhani text-xl text-slate-300 max-w-2xl mx-auto mb-10">
            Connect with the players, trade items, find a guild, and get the latest updates directly from the Streak Play Team.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <SciFiButton 
              ...
              icon={<MessageCircle />}
              href="https://discord.gg/RFCDNrxa"
              target="_blank"
            >
              Join Discord Server
            </SciFiButton>
